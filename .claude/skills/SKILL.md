...
description:
  React  performance optimization guidelines from Vercel Engineering. This skill should be used when writing, reviewing, or refactoring
  React code to ensure optimal performance patterns. Triggers on tasks involving React components, data fetching, bundle optimization, or
...
Comprehensive performance optimization guide for React.js applications, containing 40+ rules across 7 categories. Rules are prioritized by
...
```
mgrep -l "suspense" references/rules/
mgrep -l "barrel" references/rules/
mgrep -l "swr" references/rules/
```
